...
| ~~**F-10**~~ **F-10a** | **`s_user_jobrole_task.catalogue_task_id`** — keyed on **(jobrole, task)** | — | **2** | **M** · 85,663 rows | the chain's last name-join | — | AT-F10 | DB | ✅ **CLOSED 2026-08-13** — 80,064 keyed, **prediction and outcome agree exactly**; NULL 5,599 = 5,470 ambiguous (F-10b) + 126 tenant-authored + 3 empty-task |
