@if(isset($data['downloadContent']))
    <div class="card">
        @foreach($data['downloadContent'] as $key => $value)
            <div class="row rowData">
                ...
                <div class="col-md-2 actionDiv">
                    ...
                    @php 
                        ...
                        $class_shared = $class_copy = $class_starred = "";
                    ...
                    @endphp
                    <div class="actionIcons {{$class_shared}}  shared_{{$value['id']}}">
                        <a class="iconsAchor " onclick="addActivity({{$value['id']}},'shared');"   data-toggle="modal" data-target="#shareContent4_{{$value['id']}}"><i class="fa fa-share-alt"></i></a>
                    </div>
                    <div class="actionIcons {{$class_starred}} starred_{{$value['id']}}">
                        <a class="iconsAchor " onclick="addActivity({{$value['id']}},'starred');"><i class="mdi mdi-star star_{{$value['id']}}"></i></a>
                    </div>
                    <div class="actionIcons {{$class_copy}} copy_{{$value['id']}}">
            ...
            <!-- content share model  -->
            <div class="modal fade" id="shareContent4_{{$value['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
