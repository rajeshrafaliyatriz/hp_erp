@if(isset($data['copyContent']))
    <div class="card">
        @foreach($data['copyContent'] as $key => $value)
            <div class="row rowData">
                ...
                <div class="col-md-2 actionDiv">
                    ...
                    <div class="actionIcons {{$class_shared}}  shared_{{$value['id']}}">
                        <a class="iconsAchor " onclick="addActivity({{$value['id']}},'shared');" data-toggle="modal" data-target="#shareContent5_{{$value['id']}}" ><i class="fa fa-share-alt"></i></a>
                    </div>
             ...
             <!-- content share model  -->
             <div class="modal fade" id="shareContent5_{{$value['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
