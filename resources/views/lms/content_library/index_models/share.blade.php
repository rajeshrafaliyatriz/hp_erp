@if(isset($data['sharedContent']))
    <div class="card">
        @foreach($data['sharedContent'] as $key => $value)
            <div class="row rowData">
                ...
                <div class="col-md-2 actionDiv">
                    ...
                    <div class="actionIcons {{$class_shared}}  shared_{{$value['id']}}">
                        <a class="iconsAchor" data-toggle="modal" data-target="#shareContent2_{{$value['id']}}" onclick="addActivity({{$value['id']}},'shared');"><i class="fa fa-share-alt"></i></a>
                    </div>
            ...
            <!-- content share model  -->
            <div class="modal fade" id="shareContent2_{{$value['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
